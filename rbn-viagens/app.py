...
# --- Ajustes para deployment: permite configurar caminhos via variáveis de ambiente ---
UPLOAD_DIR = os.environ.get('UPLOAD_DIR', UPLOAD_DIR) if 'UPLOAD_DIR' in globals() else os.environ.get('UPLOAD_DIR', os.path.join(os.path.dirname(__file__), 'uploads'))
DB_PATH = os.environ.get('DB_PATH', DB_PATH) if 'DB_PATH' in globals() else os.environ.get('DB_PATH', os.path.join(os.path.dirname(__file__), 'rbn_trip_expenses.db'))
